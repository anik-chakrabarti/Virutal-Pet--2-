...
function setup() {
  ...
  feedMilkButton = createButton('Add Food');
  feedMilkButton.position(850,40);
  feedMilkButton.mousePressed(AddFood);
  feedMilkButton.size(100);
...
function lastFed(){
  ...
  fill(20);
  textSize(20);
  text("Last Feed: " + hour1 + " " + time , 550,80);    
}
